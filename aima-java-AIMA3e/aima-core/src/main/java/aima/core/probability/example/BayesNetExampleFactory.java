...
public class BayesNetExampleFactory {
	...
	public static BayesianNetwork constructWorldCupSoccer() {
		
		FiniteNode age = new FullCPTNode(ExampleRV.AGE_RV, new double[] {
				0.3, 0.6, 0.1 });
		FiniteNode nationality = new FullCPTNode(ExampleRV.NATIONALITY_RV, new double[] {
				0.2, 0.8 });
		
		
		
		@SuppressWarnings("unused")
		FiniteNode sports = new FullCPTNode(ExampleRV.SPORTS_RV,new double[]{
				//a1 b1 c1
		...
		@SuppressWarnings("unused")
		FiniteNode watchTv = new FullCPTNode(ExampleRV.WATCHTV_RV, new double[] {
				//c1 d1
				0.7,
				//c1 d2
				0.2,
